...
printsettingsDMD2::printsettingsDMD2(QWidget* parent) :
    QWidget(parent),
...
void printsettingsDMD2::initSettingsPointers(PrintSettings* pPrintSettings, PrintControls* pPrintControls
...
void printsettingsDMD2::logCurrentSettingsToFile() {
    QFile file("C:/Users/HOME-PC/Documents/CLIP3DPrinterGUI/settings_logDMD2.txt");
...
void printsettingsDMD2::initPrintSettings() {
    ...
    if (psPrintSettingsDMD2->MotionMode == STEPPED) {
        ...
        qDebug() << "DMD 2 MotionMode: STEPPED";
